 ...
 */
public class RandomAccessWhiteboxRaster extends WhiteboxRasterBase implements WhiteboxRasterInterface {
     ...
     */
    public RandomAccessWhiteboxRaster(String HeaderFile, String FileAccess)
    {
     ...
     */
    public RandomAccessWhiteboxRaster(String HeaderFile, String FileAccess, double BufferSize)
    {
        // set the header file and data file.
        headerFile = HeaderFile;
        dataFile = headerFile.replace(".dep", ".tas");
     ...
     */
    public RandomAccessWhiteboxRaster(String HeaderFile, String FileAccess, String BaseRasterHeader, DataType dataType, double InitialValue)
    {
        // set the header file and data file.
        headerFile = HeaderFile;
        dataFile = headerFile.replace(".dep", ".tas");
     ...
     */
    public RandomAccessWhiteboxRaster(String HeaderFile, String FileAccess, String BaseRasterHeader, DataType dataType, double InitialValue, double BufferSize)
    {
        // set the header file and data file.
        headerFile = HeaderFile;
        dataFile = headerFile.replace(".dep", ".tas");
    ...
    public RandomAccessWhiteboxRaster(String HeaderFile, double north, double south, double east, double west, int rows, int cols, DataScale dataScale, DataType dataType, double initialValue, double noData)
    {
        // set the header file and data file.
        headerFile = HeaderFile;
        dataFile = headerFile.replace(".dep", ".tas");
